...
/// , use new THREE.BufferAttribute().setDynamic( true ).
@JS()
...
/// Use geometry.merge( geometry2, matrix, materialIndexOffset ).
...
class ShaderMaterial extends Material {
  ...
  /// Use extensions.derivatives instead.
...
class Box2 {
  ...
  external Vector2 getCenter([Vector2 optionalTarget]);
  external Vector2 getSize([Vector2 optionalTarget]);
...
class Box3 {
  ...
  external bool isEmpty();
  external Vector3 getCenter([Vector3 optionalTarget]);
  external Vector3 getSize([Vector3 optionalTarget]);
